...
import RegimentTRRBLogo from '../assets/TRRB.png';
...
const RegimentTRRB = () => {
  ...
  const achievements = [
    { icon: 'fa-medal', text: 'RGL Season 5 - 2nd Place', color: 'gray' },
    { icon: 'fa-award', text: 'HRL Season 5 - 3rd Place', color: 'orange' },
  ];

  const notablePlayers = ['Rave', 'Chrome', 'Mattbob'];
          ...
          <div className="lg:col-span-3 space-y-6 flex flex-col">
            ...
            >
              <div className="w-32 h-32 rounded-full bg-sky-50 flex items-center justify-center shadow border border-sky-100 mb-4">
                <img src={RegimentTRRBLogo} alt="TRRB Regiment Logo" className="w-full h-full object-contain p-2" />
              </div>
              <h3 className="text-xl font-bold text-gray-800 mb-3">TRRB Regiment</h3>
              <a 
                href="https://discord.gg/trrb" 
                target="_blank" 
          ...
          <div className="lg:col-span-9">
            ...
            >
              <div className="h-full flex flex-col">
                ...
                The TRRB is a relatively new British regiment that emerged as a spinoff of the TRR. Despite its youth, the regiment has achieved impressive competitive success under Rave's leadership. The TRRB has quickly established itself as a powerhouse that competitors have come to fear.
                </p>
                      ...
                      <div className="rounded-lg overflow-hidden shadow-md">
                        <div className="aspect-video">
                          <iframe
                            ...
                            src="https://www.youtube.com/embed/IJtR43b-gHI?autoplay=1&mute=1"
