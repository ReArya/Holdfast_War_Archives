...
import NWLSeason6Logo from '../assets/NWL Season 6.svg';
                        ...
                        <div className="bg-white rounded-xl shadow-lg overflow-visible border border-gray-100 h-full">
                            ...
                            <div className="p-8">
                                ...
                                <div className="text-lg leading-relaxed text-gray-700">
                                    <p>
                                      Hot off of NWL Season 5, the 63e were able to repeat the same script toppling the 7.Fuß in a dominant fashion to secure a back-to-back NWL championship. There was no 3rd place match and as a result, both the 45e and KRA were to share the bronze medal.
                                    </p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table className="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody className="bg-white divide-y divide-gray-200">
                                            ...
                                            <tr className="hover:bg-gray-50">
                                                ...
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">SCP 38</td>
                                            ...
                                            <tr className="hover:bg-gray-50">
                                                ...
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">3ème</td>
