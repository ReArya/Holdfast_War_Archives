...
// Kumite Season 5 Page

import React, { useState, useRef, useEffect } from 'react';
import { useNavigate } from 'react-router-dom';
import KumiteSeason5Logo from '../assets/Kumite Season 5.png';
                ...
                <section className="bg-white rounded-xl shadow-lg overflow-visible border border-gray-100 mb-12 max-w-2xl mx-auto">
                    ...
                    <div className="p-8">
                        <div className="text-center">
                            <img
                                src={KumiteSeason5Logo}
                                alt="Kumite Season 5 Scoreboard"
