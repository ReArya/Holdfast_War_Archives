...
const Regiment7Fuß = () => {
  ...
  const achievements = [
    { icon: 'fa-medal', text: 'RGL Season 4 - 2nd Place', color: 'gray' },
    { icon: 'fa-trophy', text: 'RGL Season 5 - 1st Place', color: 'yellow' },
    { icon: 'fa-medal', text: 'NWL Season 6 - 2nd Place', color: 'gray' },
    { icon: 'fa-medal', text: 'HAL Season 2 - 2nd Place', color: 'gray' },
    { icon: 'fa-award', text: 'HRL Season 4 - 3rd Place', color: 'orange' },
    { icon: 'fa-trophy', text: 'HRL Season 5 - 1st Place', color: 'yellow' },
  ];

  const notablePlayers = ['Reddishh', 'Bacon', 'Tom'];
          ...
          <div className="lg:col-span-3 space-y-6 flex flex-col">
            ...
            >
              <div className="w-32 h-32 rounded-full bg-sky-50 flex items-center justify-center shadow border border-sky-100 mb-4">
                <img src={Regiment7FußLogo} alt="7Fuß Regiment Logo" className="w-full h-full object-contain p-2" />
              </div>
              <h3 className="text-xl font-bold text-gray-800 mb-3">7Fuß Regiment</h3>
              <a 
                href="https://discord.gg/7fuss" 
                target="_blank" 
          ...
          <div className="lg:col-span-9">
            ...
            >
              <div className="h-full flex flex-col">
                ...
                The 7.Fuß serves as the biggest Prussian regiment in the holdfast community, boasting an impressive roster of dedicated members. The regiment has come into their own with a multitude of competitive successes to their name, establishing themselves as a formidable force across multiple leagues.
                </p>
                      ...
                      <div className="rounded-lg overflow-hidden shadow-md">
                        <div className="aspect-video">
                          <iframe
                            ...
                            src="https://www.youtube.com/embed/bfMFepId3Jk?autoplay=1&mute=1"
                            title="7Fuß Regiment Battle Footage"
                            frameBorder="0"
