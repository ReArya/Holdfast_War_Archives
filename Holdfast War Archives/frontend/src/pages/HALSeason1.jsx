                        ...
                        <div className="bg-white rounded-xl shadow-lg overflow-visible border border-gray-100 h-full">
                            ...
                            <div className="p-8">
                                ...
                                <div className="text-lg leading-relaxed text-gray-700">
                                    <p>
                                      HAL Season 1 marked the first season of the Holdfast Artillery League. The league focused on arty versus arty fights as regiments try to outshoot and outmanuever their enemy. Ultimately, the 45e would claim the inaugural league title besting the 77th in a thrilling comeback. The newly formed 7th Hants would defeat the long standing artillery powerhouse KRA to achieve a podium bronze result.
                                    </p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table className="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody className="bg-white divide-y divide-gray-200">
                                            <tr className="hover:bg-gray-50">
                                                ...
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">33</td>
                                            </tr>
                                            <tr className="hover:bg-gray-50">
                                                ...
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">37</td>
                                            </tr>
                                            <tr className="hover:bg-gray-50">
                                            ...
                                            <tr className="hover:bg-gray-50">
                                                ...
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">87 RRE</td>
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">2-3-0</td>
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">21</td>
                                            </tr>
                                            <tr className="hover:bg-gray-50">
                                                <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">6</td>
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">4th KG</td>
                                ...
                                <div className="overflow-x-auto">
                                    <table className="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody className="bg-white divide-y divide-gray-200">
                                            <tr className="hover:bg-gray-50">
                                                <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">1</td>
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">7th Hants</td>
                                            ...
                                            <tr className="hover:bg-gray-50">
                                                <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">5</td>
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">FRL</td>
