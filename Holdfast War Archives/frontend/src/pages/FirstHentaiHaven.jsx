...
import FirstHentaiHavenLogo from '../assets/First Hentai Haven.svg';
import '@fortawesome/fontawesome-free/css/all.min.css'; // Import FontAwesome CSS

const FirstHentaiHaven = () => {
...
export default FirstHentaiHaven;