                ...
                <section className="bg-white rounded-xl shadow-lg overflow-visible border border-gray-100 mb-12 max-w-2xl mx-auto">
                    ...
                    <div className="p-8">
                        <div className="text-center">
                            <img
                                src={Summer2022NormalTourneyLogo}
                                alt="Summer 2022 Normal Tourney"
...
export default Summer2022NormalTourney;