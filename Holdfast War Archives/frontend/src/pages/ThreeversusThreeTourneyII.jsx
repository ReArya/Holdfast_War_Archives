// Albert Mendez IV
// ThreeversusThreeTourneyII.jsx
// Holdfast War Archives
// Three Versus Three Tourney II Page

import React, { useState, useRef, useEffect } from 'react';
import { useNavigate } from 'react-router-dom';
import ThreeVersusThreeTourneyIILogo from '../assets/Three v Three Tourney II.svg';
import ThreeVersusThreeTourneyIITeams from '../assets/Teams 3v3 Tourney II.png';
...
const Dropdown = ({ title, options, isOpen, toggleDropdown, id, onOptionClick }) => {
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            {/* Dropdown menu with fixed height for items and overflow */}
            {isOpen && (
                <div 
...
const ThreeVersusThreeTourneyII = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-blue-50 to-gray-100">
            ...
            <main className={`max-w-6xl mx-auto px-4 pb-16 transition-all duration-1000 ease-in-out ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                                ...
                                <ul className="space-y-4">
                                    ...
                                    <li className="flex items-center space-x-3 bg-white p-4 rounded-lg shadow-md border border-gray-100 transition-transform hover:scale-[1.02] duration-300">
                                        ...
                                        <span className="text-lg font-semibold text-gray-800">
                                            Winner: XMG Melee (eLF, Fires, Billjet, Etwa, Rufus)
                                        </span>
                                    </li>
                                    {/* Second */}
                                    <li className="flex items-center space-x-3 bg-white p-4 rounded-lg shadow-md border border-gray-100 transition-transform hover:scale-[1.02] duration-300">
                                        ...
                                        <span className="text-lg font-semibold text-gray-800">
                                            Second: Z0FT & Others (Z0FT, Toasted, Jeff King, Chung, Comandosim)
                                        </span>
                                    </li>
                                    {/* Third */}
                                    <li className="flex items-center space-x-3 bg-white p-4 rounded-lg shadow-md border border-gray-100 transition-transform hover:scale-[1.02] duration-300">
                                        ...
                                        <span className="text-lg font-semibold text-gray-800">
                                            Third: Girl Gang (Ben, Rickdick, Siege, Gondal, Jayy)
                                        </span>
                                    </li>
                                </ul>
                                {/* Calendar */}
                ...
                {/* Images Section in two separate containers side by side */}
                <div className="flex flex-col md:flex-row gap-8">
                    {/* Tournament Bracket Container */}
                    <section className="md:w-1/2 bg-white rounded-xl shadow-lg overflow-visible border border-gray-100 mb-12">
                        <div className="relative">
                            <div className="bg-gradient-to-r from-sky-700 to-blue-600 h-1 w-full rounded-t-xl" />
                        </div>
                        <div className="p-6">
                            <div className="text-center">
                                <h3 className="text-xl font-semibold text-gray-800 mb-4">Tournament Bracket</h3>
                                <img
                                    src={ThreeVersusThreeTourneyIILogo}
                                    alt="Three Versus Three Tourney II Bracket"
                    ...
                    <section className="md:w-1/2 bg-white rounded-xl shadow-lg overflow-visible border border-gray-100 mb-12">
                        ...
                        <div className="p-6">
                            <div className="text-center">
                                <h3 className="text-xl font-semibold text-gray-800 mb-4">Tournament Teams</h3>
                                <img
                                    src={ThreeVersusThreeTourneyIITeams}
                                    alt="Three Versus Three Tourney II Teams"
                                    className="object-contain w-full rounded-lg shadow-md"
                                />
                            </div>
                        </div>
...
export default ThreeVersusThreeTourneyII;