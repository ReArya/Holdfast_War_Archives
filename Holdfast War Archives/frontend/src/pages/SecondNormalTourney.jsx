// Albert Mendez IV
// SecondNormalTourney.jsx
// Holdfast War Archives
// Second Normal Tourney Page

import React, { useState, useRef, useEffect } from 'react';
import { useNavigate } from 'react-router-dom';
import SecondNormalTourneyLogo from '../assets/Second Normal Tourney.png';
                ...
                <section className="bg-white rounded-xl shadow-lg overflow-visible border border-gray-100 mb-12 max-w-2xl mx-auto">
                    ...
                    <div className="p-8">
                        <div className="text-center">
                            <img
                                src={SecondNormalTourneyLogo}
                                alt="2nd Normal Tourney"
...
export default SecondNormalTourney;