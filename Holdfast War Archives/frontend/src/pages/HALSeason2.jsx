...
import HALSeason2Logo from '../assets/HAL Season 2.svg';
                        ...
                        <div className="bg-white rounded-xl shadow-lg overflow-visible border border-gray-100 h-full">
                            ...
                            <div className="p-8">
                                ...
                                <div className="text-lg leading-relaxed text-gray-700">
                                    <p>
                                        HAL Season 2 was a breath of fresh air as the second season sought to solidify the ruleset. New regiments would ultimately claim the podium as the old mainstays from the previous year did not make an appearance or as far as they would have hoped. A new and up and coming regiment, the 2.BIR, edged out the 7.Fuß in the grand finals to obtain the top podium spot. The 63e would round up the top three defeating the 41e for the bronze.
                                    </p>
                                </div>
                            </div>
                        </div>
