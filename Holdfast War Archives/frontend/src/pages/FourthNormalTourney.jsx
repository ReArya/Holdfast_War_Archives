// Albert Mendez IV
// FourthNormalTourney.jsx
// Holdfast War Archives
// Fourth Normal Tourney Page

import React, { useState, useRef, useEffect } from 'react';
import { useNavigate } from 'react-router-dom';
import FourthNormalTourneyLogo from '../assets/Fourth Normal Tourney.svg';
                ...
                <section className="bg-white rounded-xl shadow-lg overflow-visible border border-gray-100 mb-12 max-w-2xl mx-auto">
                    ...
                    <div className="p-8">
                        <div className="text-center">
                            <img
                                src={FourthNormalTourneyLogo}
                                alt="4th Normal Tourney"
...
export default FourthNormalTourney;