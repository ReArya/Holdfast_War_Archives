// Albert Mendez IV
// July2021Leaderboard.jsx
// Holdfast War Archives
// July 2021 Leaderboard Page

import React, { useState, useRef, useEffect } from 'react';
import { useNavigate } from 'react-router-dom';
import July2021LeaderboardLogo from '../assets/July 2021 Leaderboard.svg';
                ...
                <section className="bg-white rounded-xl shadow-lg overflow-visible border border-gray-100 mb-12 max-w-2xl mx-auto">
                    ...
                    <div className="p-8">
                        <div className="text-center">
                            <img
                                src={July2021LeaderboardLogo}
                                alt="July 2021 Leaderboard"
...
export default July2021Leaderboard;