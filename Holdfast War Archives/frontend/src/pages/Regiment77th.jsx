...
import Regiment77thLogo from '../assets/77th.png';
...
const Regiment77th = () => {
  ...
  const achievements = [
    { icon: 'fa-medal', text: 'NWL Season 2 - 2nd Place', color: 'gray' },
    { icon: 'fa-medal', text: 'HAL Season 1 - 2nd Place', color: 'gray' },
  ];

  const notablePlayers = ['Ed', 'ToasterCoaster', 'Lavatsj'];
          ...
          <div className="lg:col-span-3 space-y-6 flex flex-col">
            ...
            >
              <div className="w-32 h-32 rounded-full bg-sky-50 flex items-center justify-center shadow border border-sky-100 mb-4">
                <img src={Regiment77thLogo} alt="77th Regiment Logo" className="w-full h-full object-contain p-2" />
              </div>
              <h3 className="text-xl font-bold text-gray-800 mb-3">77th Regiment</h3>
              <a 
                href="https://discord.gg/77th" 
                target="_blank" 
            ...
            >
              <div className="h-full flex flex-col">
                <p className="text-base text-gray-700 mb-4">
                  The 77th is one of the oldest Holdfast regiments in the community and has been a participant in various leagues throughout its lifespan. When one thinks of the 77th it's Colonel Ed is the first person that comes to mind. A well rounded and well renowned player in the North American community.
                </p>
                      ...
                      <div className="rounded-lg overflow-hidden shadow-md">
                        <div className="aspect-video">
                          <iframe
                            ...
                            src="https://www.youtube.com/embed/eFfrMNHk-VU?autoplay=1&mute=1"
                            title="77th Regiment Battle Footage"
                            frameBorder="0"
