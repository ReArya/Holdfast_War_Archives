...
import NWLSeason5Logo from '../assets/NWL Season 5.svg';
                        ...
                        <div className="bg-white rounded-xl shadow-lg overflow-visible border border-gray-100 h-full">
                            ...
                            <div className="p-8">
                                ...
                                <div className="text-lg leading-relaxed text-gray-700">
                                    <p>
                                       NWL Season 5 served as a breakthrough season for the 63e. After spending many seasons resulting in a third place finish the 63e finally was able to not only make the grand finals, but achieve a gold medal result. The KRA once again made the finals, but came up short once more to the 63e. The 45e edged out the 7.Fuß for a third place podium finish.
                                    </p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table className="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody className="bg-white divide-y divide-gray-200">
                                            ...
                                            <tr className="hover:bg-gray-50">
                                                ...
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">0-3-2</td>
                                    ...
                                    <table className="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody className="bg-white divide-y divide-gray-200">
                                            ...
                                            <tr className="hover:bg-gray-50">
                                                ...
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">2-2-0</td>
