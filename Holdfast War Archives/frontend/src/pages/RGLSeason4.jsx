...
import RGLSeason4Logo from '../assets/RGL Season4.svg';
                        ...
                        <div className="bg-white rounded-xl shadow-lg overflow-visible border border-gray-100 h-full">
                            ...
                            <div className="p-8">
                                ...
                                <div className="text-lg leading-relaxed text-gray-700">
                                    <p>
                                        The fourth season of RGL proved to be one full of surprises. A new regiment in the 7.Fuß would make the final stage for the first time. Despite this, the 63e would win the tourney and be the first back-to-back champions in RGL history. The 45e would have a strong showing once again securing a third place finish as they fell short to the 7.Fuß in the loser bracket.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-8">
                            ...
                            <div className="flex justify-center">
                                <div className="w-full max-w-3xl">
                                    <img
                                        src={RGLSeason4Logo}
                                        alt="RGL Season 4 Tournament Bracket"
                                ...
                                <table className="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody className="bg-white divide-y divide-gray-200">
                                        ...
                                        <tr className="hover:bg-gray-50">
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">2-2</td>
                                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">44</td>
                                        </tr>
                                        <tr className="hover:bg-gray-50">
                                        ...
                                        <tr className="hover:bg-gray-50">
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">0-3</td>
