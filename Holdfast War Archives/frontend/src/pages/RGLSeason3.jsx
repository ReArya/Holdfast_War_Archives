...
import RGLSeason3Logo from '../assets/RGL Season3.svg';
                        ...
                        <div className="bg-white rounded-xl shadow-lg overflow-visible border border-gray-100 h-full">
                            ...
                            <div className="p-8">
                                ...
                                <div className="text-lg leading-relaxed text-gray-700">
                                    <p>
                                        The third season of RGL Season 3 was fierce and full of close matches throughout not only the group stage, but the final stage as well. The 63e would end up victorious capturing their first RGL victory which seemingly alluded them the previous two seasons. The 51st, a european regiment filled with ex TRR members would fall short in the finals, but secure a second place finish. Although the defending champions 45e would not make the grand final, they would finish on the podium defeating the KRA in a close 15-14 match.
                                    </p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table className="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody className="bg-white divide-y divide-gray-200">
                                            <tr className="hover:bg-gray-50">
                                                ...
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">51st</td>
