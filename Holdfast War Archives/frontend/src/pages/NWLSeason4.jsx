...
import NWLSeason4Logo from '../assets/NWL Season 4.svg';
                        ...
                        <div className="bg-white rounded-xl shadow-lg overflow-visible border border-gray-100 h-full">
                            ...
                            <div className="p-8">
                                ...
                                <div className="text-lg leading-relaxed text-gray-700">
                                    <p>
                                       NWL Season 4 was a close nail bitter tournament throughout both the group and final stages. Ultimately, the 45e would come out on top as they defeated the KRA who once again secured a silver medal. The newly formed 7thHants regiment would tople the 63e to achieve a bronze podium result.
                                    </p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table className="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody className="bg-white divide-y divide-gray-200">
                                            <tr className="hover:bg-gray-50">
                                                ...
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">3-1</td>
                                            ...
                                            <tr className="hover:bg-gray-50">
                                                ...
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">2-2</td>
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">10</td>
                                            </tr>
                                            <tr className="hover:bg-gray-50">
                                            ...
                                            <tr className="hover:bg-gray-50">
                                                ...
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">0-4</td>
                                ...
                                <div className="overflow-x-auto">
                                    <table className="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody className="bg-white divide-y divide-gray-200">
                                            ...
                                            <tr className="hover:bg-gray-50">
                                                <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">2</td>
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">7thHants</td>
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">3-1</td>
                                            ...
                                            <tr className="hover:bg-gray-50">
                                                <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">4</td>
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">KSG</td>
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">1-3</td>
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">7</td>
                                            </tr>
                                            <tr className="hover:bg-gray-50">
                                                <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">5</td>
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">22LR</td>
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">0-4</td>
