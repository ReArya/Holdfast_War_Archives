...
const RegimentNo16 = () => {
  ...
  const notablePlayers = ['Highlander', 'SpicyPaper', 'Flex'];
          ...
          <div className="lg:col-span-3 space-y-6 flex flex-col">
            ...
            >
              <div className="w-32 h-32 rounded-full bg-sky-50 flex items-center justify-center shadow border border-sky-100 mb-4">
                <img src={RegimentNo16Logo} alt="No16 Regiment Logo" className="w-full h-full object-contain p-2" />
              </div>
              <h3 className="text-xl font-bold text-gray-800 mb-3">No. 16 Regiment</h3>
              <a 
                href="https://discord.gg/no16" 
                target="_blank" 
            ...
            >
              <div className="h-full flex flex-col">
                <p className="text-base text-gray-700 mb-4">
                  The No. 16 emerged as a spin-off of the 47e following leadership disagreements. This up-and-coming group, led by Highlander, features an abundance of homegrown talent as they position themselves to become a formidable threat in various competitive leagues. 
                </p>
                      ...
                      <div className="rounded-lg overflow-hidden shadow-md">
                        <div className="aspect-video">
                          <iframe
                            ...
                            src="https://www.youtube.com/embed/bc1uzXM1CyA?autoplay=1&mute=1"
                            title="26th Regiment Battle Footage"
                            frameBorder="0"
