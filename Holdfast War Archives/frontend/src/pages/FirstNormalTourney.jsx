// Albert Mendez IV
// FirstNormalTourney.jsx
// Holdfast War Archives
// First Normal Tourney.jsx

import React, { useState, useRef, useEffect } from 'react';
import { useNavigate } from 'react-router-dom';
import FirstNormalTourneyLogo from '../assets/First Normal Tourney.png';
                ...
                <section className="bg-white rounded-xl shadow-lg overflow-visible border border-gray-100 mb-12 max-w-2xl mx-auto">
                    ...
                    <div className="p-8">
                        <div className="text-center">
                            <img
                                src={FirstNormalTourneyLogo}
                                alt="1st Normal Tourney"
...
export default FirstNormalTourney;