...
import KumiteSeason1Logo from '../assets/Kumite Season 1.png';
    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-100">
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        <section className="text-center mt-8">
          <img
            src={KumiteSeason1Logo}
            alt="Kumite Season 1 Scoreboard"
            className="object-cover w-full max-w-2xl mx-auto rounded-lg shadow-lg"
          />
        </section>

        {/* Notes */}
        <section className="text-center mt-4 text-sm text-gray-600">
          <p>*Red names are NA</p>
          <p>*Blue names are EU</p>
        </section>
