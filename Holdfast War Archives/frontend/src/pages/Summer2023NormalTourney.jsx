// Albert Mendez IV
// Summer2023NormalTourney.jsx
// Holdfast War Archives
// Summer 2023 Normal Tourney Page

import React, { useState, useRef, useEffect } from 'react';
import { useNavigate } from 'react-router-dom';
import Summer2023NormalTourneyLogo from '../assets/Summer 2023 Normal Tourney.png';
                ...
                <section className="bg-white rounded-xl shadow-lg overflow-visible border border-gray-100 mb-12 max-w-2xl mx-auto">
                    ...
                    <div className="p-8">
                        <div className="text-center">
                            <img
                                src={Summer2023NormalTourneyLogo}
                                alt="Summer2023NormalTourneyLogo"
...
export default Summer2023NormalTourney;