...
// Kumite Season 4 Page

import React, { useState, useRef, useEffect } from 'react';
import { useNavigate } from 'react-router-dom';
import KumiteSeason4Logo from '../assets/Kumite Season 4.png';
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-blue-50 to-gray-100">
            ...
            <main className={`max-w-6xl mx-auto px-4 pb-16 transition-all duration-1000 ease-in-out ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                ...
                {/* Image Section - Modified to match content proportions rather than stretching */}
                <section className="max-w-3xl mx-auto bg-white rounded-xl shadow-lg overflow-visible border border-gray-100 mb-12">
                    <div className="relative">
                        <div className="bg-gradient-to-r from-sky-700 to-blue-600 h-1 w-full rounded-t-xl" />
                    </div>
                    <div className="p-6">
                        <div className="flex justify-center">
                            <div className="relative w-full">
                                <img
                                    src={KumiteSeason4Logo}
                                    alt="Kumite Season 4 Scoreboard"
