...
import NWLSeason2Logo from '../assets/NWL Season 2.svg';
                        ...
                        <div className="bg-white rounded-xl shadow-lg overflow-visible border border-gray-100 h-full">
                            ...
                            <div className="p-8">
                                ...
                                <div className="text-lg leading-relaxed text-gray-700">
                                    <p>
                                       NWL Season 2 proved to be one of drama from the group stages all the way to the finals. The 77th were poised to win on the back of Colonel Ed and his pistol skill which almost singlehandily secured the gold medal. However, the 45e would prove too much as they made it through the loser's bracket to force a bracket reset in the grand final. The 45e would end up winning said bracket reset to secure the gold medal.
                                    </p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table className="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody className="bg-white divide-y divide-gray-200">
                                            <tr className="hover:bg-gray-50">
                                                ...
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">44</td>
                                            </tr>
                                            <tr className="hover:bg-gray-50">
                                                ...
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">41</td>
                                            </tr>
                                            <tr className="hover:bg-gray-50">
                                                <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">3</td>
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">Lgn.Ir</td>
                                            ...
                                            <tr className="hover:bg-gray-50">
                                                ...
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">37th</td>
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">2-3-0</td>
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">23</td>
                                            </tr>
                                            <tr className="hover:bg-gray-50">
                                                <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">5</td>
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">21st</td>
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">1-4-0</td>
                                            ...
                                            <tr className="hover:bg-gray-50">
                                                ...
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">13tes</td>
                                    ...
                                    <table className="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody className="bg-white divide-y divide-gray-200">
                                            ...
                                            <tr className="hover:bg-gray-50">
                                                ...
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">3-1-1</td>
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">34</td>
                                            </tr>
                                            <tr className="hover:bg-gray-50">
                                                <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">4</td>
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">7.Fuß</td>
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">2-2-1</td>
                                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">30</td>
                                            </tr>
                                            <tr className="hover:bg-gray-50">
                                                <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">5</td>
